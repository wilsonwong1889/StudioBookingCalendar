...
class NotificationServiceTest(unittest.TestCase):
    ...
    def test_send_email_smtp_backend_uses_configured_server(self) -> None:
        with patch.object(notification_service.settings, "EMAIL_BACKEND", "smtp"), patch.object(
            notification_service.settings, "EMAIL_FROM", "adminstudiobipoc@gmail.com"
        ), patch.object(
            notification_service.settings, "EMAIL_REPLY_TO", "adminstudiobipoc@gmail.com"
        ), patch.object(
            notification_service.settings, "SMTP_HOST", "smtp.gmail.com"
        ), patch.object(
            notification_service.settings, "SMTP_PORT", 587
        ), patch.object(
            notification_service.settings, "SMTP_USERNAME", "adminstudiobipoc@gmail.com"
        ), patch.object(
        ...
        client.login.assert_called_once_with("adminstudiobipoc@gmail.com", "app-password")
